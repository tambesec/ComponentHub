              ...
              <form>
                ...
                <div className="mb-5">
                  ...
                  <select
                    name="gender"
                    id="gender"
                    className="rounded-lg border border-gray-3 bg-gray-1 text-dark w-full py-3 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20"
                  >
