        ...
        <div className="grid grid-cols-5 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li className="hover:text-green-600 cursor-pointer capitalize">Router</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">Switch</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">Kích sóng wifi</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">hub-switch</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">card mạng</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">uSB wifi</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">camera</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">phụ kiện mạng</li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li className="hover:text-green-600 cursor-pointer capitalize">About pee</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">liên hệ</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">career</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">Blog</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">Sitemap</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">vị trí cửa hàng</li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li className="hover:text-green-600 cursor-pointer capitalize">dịch vụ khách hàng</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">chính sách</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">điều khoản</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">theo dõi đơn</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">FAQs</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">tài khoản của tôi</li>
              <li className="hover:text-green-600 cursor-pointer capitalize">hỗ trợ sản phẩm</li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <div className="flex mb-4">
              <input
                ...
                className="flex-1 px-4 py-2 border border-gray-300 rounded-l-lg text-sm outline-none focus:border-green-600"
              />
              <button className="bg-green-600 text-white px-6 py-2 rounded-r-lg text-sm font-bold uppercase hover:bg-green-700">
                đăng ký
              </button>
            </div>
